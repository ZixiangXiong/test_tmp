...
def main(p1,p2):
    ...
    data_dir = r"/gpfs/home/zx18/PycharmProjects/pythonProject"
    ...
    for ntime in range(nassim):
        ...
        if use_letkf is True and use_ensf is False:  ##1234567890  ##letkf update
            ...
            if ntime == nassim - 1:
                ...
                #df.to_csv("RMSE_letkf_12hr_{}_{}_{}linear_{}arctan_{}_{}.csv".format(obs_network_type, nobs,int((1 - percentage_arctan) * 100),int(percentage_arctan * 100),
                #           int(hcovlocal_scale / 1000.),int(covinflate1 * 1000)),index=False)  ##1234567890
...
if __name__ == "__main__":
    p1 = np.float64(sys.argv[1])
    p2 = np.float64(sys.argv[2])
    main(p1, p2)